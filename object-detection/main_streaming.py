...
def draw_objects(request):
    ...
    with MappedArray(request, "main") as m:
        ...
        xt, yt, wt, ht = draw.textbbox((15, 15), label_fps, font=font)
        text_image = Image.new("RGBA", (wt, ht), (0, 0, 0, 0))  # Transparent background
        text_draw = ImageDraw.Draw(text_image)
        text_draw.text((0, 0), label_fps, fill=(255, 0, 0), font=font)
